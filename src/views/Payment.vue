<template>
  <div class="bg-primary mb-4">
    <div class="container py-4">
      <h3 class="text-white mt-2">Pagamento</h3>
      ...
      <nav class="d-flex mb-2">
        <h6 class="mb-0">
          ...
          <RouterLink to="/about" class="text-white-50">Sobre</RouterLink>
            <span class="text-white-50 mx-2">&gt;</span>
          <RouterLink to="/checkout" class="text-white"><u>Checkout</u></RouterLink>
        </h6>
      </nav>
    </div>
  </div>
          ...
          <div class="card text-center">
            <div class="card-header">
              <ul class="nav nav-tabs card-header-tabs" id="myTab">
                <li class="nav-item">
                  <a href="#card" class="nav-link active" data-bs-toggle="tab">Cartão</a>
                </li>
                <li class="nav-item">
                ...
                <div class="tab-pane fade show active" id="card">
                  ...
                  <form>
                    <div class="row">
                      ...
                      <div class="col">
                        <div class="mb-3">
                          <input type="text" name="numero_cartao" class="form-control border" placeholder="Número do Cartão" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        <div class="mb-3">
                          <input type="text" name="ccv" class="form-control border" placeholder="CCV" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="date" name="data_validade" id="DataValidade" class="form-control" />
                    </div>
                    <div class="mt-4">
